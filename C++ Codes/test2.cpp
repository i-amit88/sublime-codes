...
int main()
{
    ...
    printf ("Press 1 for recipt generation  and 2 for bill generation :");
    scanf("%d",&choice);
    if (choice==1)
    {
        printf("\n");
        ...
        fprintf(filep, " %s %d %d-%02d-%02d %02d:%02d:%02d %d",&v_no,rate,tm.tm_mday, tm.tm_mon + 1,tm.tm_year + 1900, tm.tm_hour, tm.tm_min, tm.tm_sec,recipt );
        fclose(filep);
        printf("\n");
        printf("================================================");
        printf("\n");
        printf(".                Pasific Parking ");
        printf("\n");
        printf("................................................");
        printf("\n");
    ...
    else if(choice==2)
    {
        ...
        int a = 0;
        printf("enter the parking slot no of which bill is to be generated:");
        scanf("%d",&a);
