...
function Videos() {
  ...
  return (
    ...
    <VStack w={'full'} >
    <video src={videoSrc} controls controlsList='nodownload' autoPlay
    style={{width:'100%',}}
    ></video>
    <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'} >
    <Heading>Sample Video</Heading>
    <Text>Lorem ipsum dolor sit, amet consectetur adipisicing elit. A asperiores explicabo ad laudantium tenetur omnis minus magni impedit consequatur, expedita fuga consequuntur quos animi, voluptate nisi sequi obcaecati provident molestiae.
    </Text>
    </VStack>
    ...
    <VStack w={['full','xl']} alignItems={'stretch'} overflowY={'auto'} p={'8'} spacing={'8'}>
        {
            videosArr.map((items,index)=>(
                <Button variant={'ghost'} colorScheme='purple' onClick={()=>setVideoSrc(items)}>Video {index+1}</Button>
            ))
        }
    </VStack>
    </Stack>
